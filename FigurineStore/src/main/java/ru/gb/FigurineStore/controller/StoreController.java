...
import ru.gb.FigurineStore.config.ConfigProperties;
...
import ru.gb.FigurineStore.service.restPay.PayProductServiceApi;
...
public class StoreController {
    ...
    public String payProduct(@RequestParam() Long idProduct) {
        ...
        ResponsePay responsePay = payProductServiceApi.pay(config.getAPI_PAY(), new DTOPyaProduct(idUser,
                priceProduct, methodPayment));
